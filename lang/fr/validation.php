...
return [
    ...
    'attributes' => [
        ...
        'vehicle_brand_id' => 'marque',
        'vehicle_model_id' => 'modèle',
        'pricing_type' => 'type tarifaire',
        'body_type' => 'carrosserie',
        'color_id' => 'couleur',
        'energy_source_id' => 'énergie',
        'vehicle_usage_id' => 'usage',
        'vehicle_category_id' => 'catégorie',
        'vehicle_gender_id' => 'genre',
        'vehicle_type_id' => 'type véhicule',
        'circulation_zone_id' => 'zone de circulation',
        'first_registration_date' => 'date de première mise en circulation',
        'seat_count' => 'nombre de places',
        'fiscal_power' => 'puissance fiscale',
        'payload_capacity' => 'charge utile',
